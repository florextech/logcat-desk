...
export const EmptyState = ({
  ...
  <div className="flx-card flex h-full min-h-[430px] items-start justify-center border-dashed bg-[rgb(11_13_12/0.86)] px-8 pb-10 pt-[11vh] text-center">
    <div className="max-w-xl rounded-[28px] border border-[rgb(38_48_40/0.7)] bg-[rgb(13_16_14/0.7)] px-10 py-12">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-[rgb(189_241_70/0.18)] bg-[rgb(189_241_70/0.08)] text-2xl text-[var(--brand-700)] shadow-[0_12px_30px_rgba(157,223,75,0.08)]">
      ...
      <h3 className="mt-3 text-[2.2rem] font-semibold tracking-tight text-[var(--foreground)]">{title}</h3>
