      ...
      <div className="space-y-5">
        ...
        {activeTab === 'adb' ? (
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-semibold uppercase tracking-[0.22em] text-(--muted)">
        ...
        {activeTab === 'general' ? (
          <div className="space-y-5">
            <div className="rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div>
                <p className="text-sm font-medium text-(--foreground)">{copy.modals.settings.languageTitle}</p>
                <p className="mt-1 text-sm text-(--muted)">{copy.modals.settings.languageHint}</p>
              </div>
            ...
            <label className="flex items-center justify-between rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div>
                <p className="text-sm font-medium text-(--foreground)">{copy.modals.settings.autoScrollTitle}</p>
                <p className="mt-1 text-sm text-(--muted)">{copy.modals.settings.autoScrollHint}</p>
              </div>
              <input
                checked={autoScroll}
                className="h-5 w-5 rounded border-(--border) bg-[rgb(11_13_12/0.9)] accent-(--brand-600)"
                type="checkbox"
            ...
            <label className="flex items-center justify-between rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div>
                <p className="text-sm font-medium text-(--foreground)">{copy.modals.settings.enableHighlightTitle}</p>
                <p className="mt-1 text-sm text-(--muted)">{copy.modals.settings.enableHighlightHint}</p>
              </div>
              <input
            ...
            <label className="flex items-center justify-between rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div>
                <p className="text-sm font-medium text-(--foreground)">{copy.modals.settings.enableGroupingTitle}</p>
                <p className="mt-1 text-sm text-(--muted)">{copy.modals.settings.enableGroupingHint}</p>
              </div>
              <input
          ...
          <div className="space-y-5">
            ...
            <label className="flex items-center justify-between rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div>
                ...
                <p className="mt-1 text-sm text-(--muted)">{copy.modals.settings.enableAIEnhancementHint}</p>
              </div>
              <input
            ...
            <div className="rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.82)] px-4 py-4">
              <div className="grid gap-3">
                ...
                <FloatingSelect
                  ...
                  buttonClassName="flx-focus flex w-full items-center justify-between rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.88)] px-4 py-3 text-sm text-(--foreground) outline-none transition focus:border-[rgb(189_241_70/0.42)] disabled:cursor-not-allowed disabled:opacity-50"
                ...
                <input
                  className="flx-focus rounded-2xl border border-(--border) bg-[rgb(11_13_12/0.88)] px-4 py-3 text-sm text-(--foreground) outline-none transition focus:border-[rgb(189_241_70/0.42)] disabled:cursor-not-allowed disabled:opacity-50"
                  disabled={aiFieldsDisabled}
